...
const team=(props)=>{
    ...
    <Row className="page_header">
       ...
       <img src={'https://res.cloudinary.com/brajapp/image/upload/v1596045319/wcdkepk3gtgmdgxwxopb.jpg' }style={{height:"250px",width:"250px",zIndex:"1",position:"absolute",bottom:"-20px",border:"3px solid white"}}></img>
        </Col>
